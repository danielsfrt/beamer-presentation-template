% DESIGN COLORS
\definecolor{accent}{HTML}{001450} % accent color
\definecolor{bgcolor}{HTML}{FFFFFF} % background color
\definecolor{bgcolorAlt}{HTML}{E6ECFF} % alternative background color
\definecolor{fgcolor}{HTML}{001450} % foreground/text color
% TUD colors
% Brillantblau: 00008C
% Dunkelblau: 001450
% Blau 1: 2F57B2
